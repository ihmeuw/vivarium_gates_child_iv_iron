...
LOW_BIRTH_WEIGHT_SHORT_GESTATION_SUB_RISK_SUM_COLUM_TEMPLATE = (
    '{LBWSG_SUB_RISK}_sum_year_{YEAR}_sex_{SEX}_age_{AGE_GROUP}'
)
LIVE_BIRTHS_COLUMN_TEMPLATE = (
    'live_births_year_{YEAR}_sex_{SEX}_age_{AGE_GROUP}'
)
LOW_WEIGHT_BIRTHS_COLUMN_TEMPLATE = (
    'low_weight_births_year_{YEAR}_sex_{SEX}_age_{AGE_GROUP}'
)
