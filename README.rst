...
from any directory.::
  ...
  (vivarium_gates_child_iv_iron) :~$ make_specs -v
  2020-06-18 18:18:28.311 | 0:00:00.679701 | build_model_specifications:48 - Writing model spec(s) to "/REPO_INSTALLATION_DIRECTORY/vivarium_gates_child_iv_iron/src/vivarium_gates_child_iv_iron/model_specifications"
...
run simulations by, e.g.::
   ...
   (vivarium_gates_child_iv_iron) :~$ simulate run -v /<REPO_INSTALLATION_DIRECTORY>/vivarium_gates_child_iv_iron/src/vivarium_gates_child_iv_iron/model_specifications/china.yaml
