...
from vivarium_gates_child_iv_iron.utilities import sanitize_location, delete_if_exists, len_longest_location
from vivarium_gates_child_iv_iron.tools.app_logging import add_logging_sink, decode_status
...
def build_single_location_artifact(
    ...
    from vivarium_gates_child_iv_iron.data import builder
